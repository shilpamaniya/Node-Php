...
$select_category_name_query = "SELECT * FROM category";
    ...
    if(isset($_POST))
    {
        ...
        if ($product_name != "" && $product_price != "" && $category_name != "" && $filename != "")
        {
            ...
            $upload_product_data = mysqli_query($conn,$upload_product_query);

            if ($upload_product_data) {
...
<form method="post" enctype="multipart/form-data">
            ...
            <input class="form-control" type="text" placeholder="Enter product Name" name="product_name"><br/>
            <label>Product Price</label>
            <input class="form-control" type="text" placeholder="Enter product Name" name="product_price"><br/>
            <label>Category Name</label>
            <select class="form-control" name="category_name">
                                             <!-- <option>Choese Category Name</option> -->
                                             <?php
