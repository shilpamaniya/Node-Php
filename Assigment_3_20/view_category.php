...
?>
  <tr>
      <td><?php echo $cnt;?></td>
      <td><?php echo $select_category_name_total['category_name'];?></td>
      <td><img  width="100px" src="<?php echo $select_category_name_total['category_image'];?>" alt=""></td>
      <td><a href="delete_category.php?category_id=<?php echo $select_category_name_total['category_id'];?>">Delete</a></td>
      <td><a href="update_category.php?category_id=<?php echo $select_category_name_total['category_id'];?>">Edit</a></td>
  </tr>
<?php
    $cnt=$cnt+1;
    }
